...
export default function SRHeaderAU({ apiData, setApiData, currentIndex, setCurrentIndex, setCurrentAccDocNo }) {
  ...
  const handleSO = async (AccDocNoC) => {
    console.log("AccDocNo in handleSO:", AccDocNoC);
      ...
      ? [
        {
          ...
          name: "All SO",
          onClick: () => handleSO(AccDocNoC, navigate),
        },
      ]
      : []),
    // ...(docStatusState === "0"
  ...
  return (
    <div className="row" style={{ padding: "5%", paddingTop: "1px" }}>
      ...
      <div className="col-md-1">&nbsp;</div>
      <div className="col-md-5">
        <DocStatusDisplay accDocNo={formData.accDocNo} DocType={formData.docType} />
      </div>
      <div>&nbsp;</div>
      <div className="col-md-6">
        <TextField
